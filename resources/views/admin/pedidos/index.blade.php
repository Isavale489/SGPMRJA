            ...
            const suggestionHtml = `
                        ...
                        $(document).ready(function () {
                            ...
                            var table = $('#pedidos-table').DataTable({
                                ...
                                columns: [
                                    { data: 'id', name: 'id', title: 'Nro. de pedido', width: '3%', className: 'text-center' },
                                    { data: 'cliente_nombre_display', name: 'cliente_nombre_display', defaultContent: 'N/A', width: '15%' },
                                    { data: 'cliente_telefono_display', name: 'cliente_telefono_display', defaultContent: 'N/A' },
                                    { data: 'fecha_pedido', name: 'fecha_pedido', width: '10%' },
                                    { data: 'fecha_entrega_estimada', name: 'fecha_entrega_estimada', width: '10%' },
                                    {
                                        data: 'estado',
                                        name: 'estado',
                                        width: '12%',
                                ...
                                buttons: [
                                    {
                                        extend: 'copy',
                                        exportOptions: {
                                            columns: [0, 1, 2, 3, 4, 5, 6, 7, 8] // Adjust columns as needed
                                        }
                                    },
                                    {
                                        extend: 'excel',
