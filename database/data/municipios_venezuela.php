...
// Catálogo geográfico de Venezuela (Estado => [Municipios]).
// Generado desde public/assets/js/municipios-venezuela.js — fuente de verdad para el seed.

return [
    'Amazonas' => ['Alto Orinoco', 'Atabapo', 'Atures', 'Autana', 'Manapiare', 'Maroa', 'Río Negro'],
    'Anzoátegui' => ['Anaco', 'Aragua', 'Bolívar', 'Bruzual', 'Cajigal', 'Carvajal', 'Diego Bautista Urbaneja', 'Freites', 'Guanipa', 'Guanta', 'Independencia', 'Libertad', 'McGregor', 'Miranda', 'Monagas', 'Peñalver', 'Píritu', 'San José de Guanipa', 'San Juan de Capistrano', 'Santa Ana', 'Simón Rodríguez', 'Sotillo'],
    ...
    'Bolívar' => ['Caroní', 'Cedeño', 'El Callao', 'Gran Sabana', 'Heres', 'Piar', 'Angostura del Orinoco', 'Roscio', 'Sifontes', 'Sucre', 'Padre Pedro Chien'],
    ...
    'Cojedes' => ['Anzoátegui', 'Ezequiel Zamora', 'Falcón', 'Girardot', 'Lima Blanco', 'Pao de San Juan Bautista', 'Ricaurte', 'Rómulo Gallegos', 'Tinaco'],
    ...
    'Guárico' => ['Camaguán', 'Chaguaramas', 'El Socorro', 'Infante', 'Las Mercedes', 'Leonardo Infante', 'Mellado', 'Miranda', 'Monagas', 'Ortíz', 'Ribas', 'Roscio', 'San Gerónimo de Guayabal', 'San José de Guaribe', 'Santa María de Ipire', 'Zaraza'],
    'La Guaira' => ['Vargas'],
