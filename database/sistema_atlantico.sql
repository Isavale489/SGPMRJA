...
INSERT INTO `persona` (`id`, `nombre`, `documento_identidad`, `tipo_documento`, `email`, `estado_geografico`, `fecha_nacimiento`, `genero`, `created_at`, `updated_at`, `deleted_at`) VALUES
