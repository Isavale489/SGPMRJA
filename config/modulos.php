...
return [
    ...
    'ordenes' => [
        ...
        'rutas' => [
            'ordenes.index|ordenes.show|ordenes.data|ordenes.pedidos-disponibles|ordenes.por-empleado|ordenes.subordenes|ordenes.insumos.index|ordenes.insumos.data' => 'ver',
